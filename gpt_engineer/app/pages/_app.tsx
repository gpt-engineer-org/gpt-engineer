// @zdanl there is two bugs here,. the prevEvent => ..., event doesn't work
// because Typescript, and the isConnected in the return of the component
// needs to be somewhat declared by type and globally
...
function App({ Component, pageProps }: AppProps<{}>) {
  ...
  useEffect(() => {
    ...
    function onGPTEvent(value: string) {
      ...
      setGPTEvents((prevValue: never[]) => [...prevValue, value] as never[]);
    }
