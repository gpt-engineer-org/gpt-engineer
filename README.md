...
- `gpt-engineer projects/my-new-project`
  - (Note, `gpt-engineer --help` lets you see all available options. For example `--steps use_feedback` uses `feedback` file in your project folder and lets you improve/fix code in a project)
