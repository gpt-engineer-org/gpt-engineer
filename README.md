...
<ul style="list-style-type: none; padding: 0; display: flex; flex-wrap: wrap;">
  <li style="margin-right: 10px; margin-bottom: 10px;">
    <a href="https://github.com/captivus" style="text-decoration: none;">
      <img src="https://avatars.githubusercontent.com/u/366332?s=64&v=4" alt="@captivus" width="64" height="64" style="border-radius: 50%;">
      <br>
      @captivus
    </a>
  </li>
  <li style="margin-right: 10px; margin-bottom: 10px;">
    <a href="https://github.com/ATheorell" style="text-decoration: none;">
      <img src="https://avatars.githubusercontent.com/u/143704446?s=64&v=4" alt="@ATheorell" width="64" height="64" style="border-radius: 50%;">
      <br>
      @ATheorell
    </a>
  </li>
  <li style="margin-right: 10px; margin-bottom: 10px;">
    <a href="https://github.com/similato87" style="text-decoration: none;">
      <img src="https://avatars.githubusercontent.com/u/71301573?s=64&v=4" alt="@similato87" width="64" height="64" style="border-radius: 50%;">
      <br>
      @similato87
    </a>
  </li>
